...
/// <summary>
/// Summary description for DatosAlumnoAcuse
/// </summary>
public class DatosAlumnoAcuse
{
    String nombre_al, correo_al, fecha_rec,
                    domicilio, colonia, municipio, nom_escu,
                    plantel, grupo;

    public DatosAlumnoAcuse(String nombre_al, String correo_al,
    ...
    public string TruncString(string cadena, int cantTruncar)
    {
        if (cadena.Length > cantTruncar)
            return cadena.Substring(0, cantTruncar);
        return cadena;
    }
